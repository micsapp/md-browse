...
.category-card { background: var(--surface); border: 1px solid var(--border); padding: 1.5rem; border-radius: 8px; box-shadow: 0 2px 4px var(--shadow); text-decoration: none; color: var(--text); transition: transform 0.2s; }
.category-card:hover { transform: translateY(-2px); }
.category-card h2 { font-size: 1.2rem; margin-bottom: 0.5rem; color: var(--text); }
.count { font-size: 0.9rem; color: var(--text2); }
.empty { grid-column: 1 / -1; text-align: center; padding: 2rem; color: var(--text3); }
</style>
