...
//
// The legacy single-file `~/.md-browse/auth.json` is migrated into a
...
const ROOT = path.join(os.homedir(), '.md-browse');
...
// One-time migration of the old single-file ~/.md-browse/auth.json into a
// profile. Returns the migrated profile name, or null if there was nothing
// to migrate. Runs at most once because the legacy file is removed on success.
